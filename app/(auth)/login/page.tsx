// app/(public)/login/page.tsx  — VERSÃO CORRIGIDA
// Mudanças:
//   1. Chama POST /api/auth/login (valida bcrypt no backend)
//   2. Salva o retorno { id, name, email, userType } no localStorage como "user"
//   3. Remove a validação de senha feita no frontend (era só protótipo)
"use client";
...
export default function LoginPage() {
  ...
  async function handleLogin(e: React.FormEvent) {
    ...
    try {
      ...
      // Salva no localStorage para o Header/Sidebar/Dashboard lerem
      ...
      <div className="bg-white p-8 rounded-2xl shadow-xl w-full max-w-md border border-gray-100">
        ...
        <div className="mt-6 text-center pt-6 border-t border-gray-50">
          <p className="text-sm text-gray-500">
            Não tem uma conta?{" "}
            <Link href="/cadastro" className="text-teal-600 font-bold hover:underline">
              Criar conta
            </Link>
          </p>
        </div>
